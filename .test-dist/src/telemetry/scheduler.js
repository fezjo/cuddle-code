...
class TriggerScheduler {
    constructor(mode) {
        ...
        this.lastSpokenAt = 0;
        this.lastClusterAt = 0;
        this.followupWindowUntil = 0;
        this.followupUsed = false;
        this.silenceLockoutUntil = 0;
        this.triggerCooldownUntil = new Map();
        this.firedByTrigger = new Map();
        this.skippedByReason = new Map();
        this.mode = mode;
    }
    updateMode(mode) {
        this.mode = mode;
    ...
    onFire(trigger, now, fromCluster) {
        this.regenTokens(now);
    ...
    canUseClusterFollowup(trigger, now) {
...
function triggerCooldownSeconds(trigger) {
    switch (trigger) {
        case "fileSaved":
